...
<body style="font-family: 'League Spartan', sans-serif;">
    ...
    <div style="line-height: 21.14px;">
        <strong><p style="position: absolute; width:200px; height: 21px; top: 450px; left: 49px; font-weight: 400px; font-size: 22.9813px;"> Bahan-bahan : </p></strong>
    </div>

    <div style="position: absolute; width: 527px; height: 210px; left: 49px; top: 500px;
    font-style: normal; font-weight: 400; font-size: 22.9813px; line-height: 25px; color: #000000;">
    ...
    <div>
        <img src="https://awsimages.detik.net.id/community/media/visual/2021/05/16/mie-kocok-bandung_43.jpeg?w=700&q=90"  alt=""; 
        style="position: absolute; width: 500px; height: 500px; left: 683px; top: 209px; border-radius: 23.8565px;">

        <img src="https://i0.wp.com/rasabunda.com/wp-content/uploads/2022/05/Mie-Kocok-Bandung.jpg?fit=450%2C600&ssl=1"  alt=""; 
        style="position: absolute; width: 500px; height: 500px; left: 683px; top: 750px; border-radius: 23.8565px;">
    </div>

    <div style="position: absolute; width: 500px; height: 21px; left: 49px; top: 800px; font-style: normal; font-weight: 400;    font-size: 22.9813px;    line-height: 25px; color: #000000;">
        <p>Pelengkap :</p>
    ...
    <div style="position: absolute;    width: 500px;    height: 25px;    left: 49px;    top: 980px; text-align: justify;   font-style: normal;    font-weight: 400;    font-size: 22.9813px;    line-height: 21px;    color: #000000;">
        <p>Langkah :</p>
    ...
    <div>
        ...
        <p style="position: absolute; width: 72px; height: 36px; left: 220px; top: 447px; font-style: normal;font-weight: 700; font-size: 22.9813px; line-height: 21px; color: #FFFFFF;">hasil</p>
        ...
        <p style="position: absolute; width: 90px; height: 36px; left: 298px; top: 447px; font-style: normal;font-weight: 700; font-size: 22.9813px; line-height: 21px; color: #FFFFFF;"> 4 porsi </p>
    </div>
