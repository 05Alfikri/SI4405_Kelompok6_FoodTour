...
<section id="register">
    ...
    <img src="" width="700" height="750" alt="foto">
</div>
<div class="col-md-6">
    <div class="form-login m-auto ps-5">
        ...
        <form action="{{ url('/register')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4">
                ...
                <span class="required" style="top: 0px; left: 41px;">*</span>
                <input type="name" id="name" class="form-control form-control-lg" name="name" placeholder="masukan name"
                    required />
            </div>
            <!-- no hp input -->
            <div class="form-outline mb-4">
            ...
            <div class="form-outline mb-4">
                ...
                <div class="text-center text-lg-start mt-4 pt-2">
                    ...
                    <p class="small fw-bold mt-2 pt-1 mb-0">anda sudah punya akun? <a href="{{ 'login' }}"
