    ...
    <div class="container">
        ...
        <form action="{{ url('/register')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4">
                ...
                <input type="no_hp" id="no_hp" class="form-control form-control-lg" name="no_hp" required style="border-radius: 50px;" />
            </div>

            <div class="mb-3">
                <label class="form-label" for="password">Password</label>
                <input type="password" id="password" class="form-control form-control-lg" name="password" required style="border-radius: 50px;" />
            </div>

            <div class="mb-3">
                <div class="form-outline mb-3">
                    <label class="form-label" for="password2">konfirmasi password</label>
                    <input type="password" id="password2" class="form-control form-control-lg" name="password2" required style="border-radius: 50px;" />
                </div>
